...
int main(int argc, char *argv[]) {
    ...
    // Initialize visibility and terrain arrays
    memset(visible, 0, sizeof(visible));
    ...
    refresh();     // Extra call to sync stdscr and force immediate display
    ...
    while (game_running) {
        ...
        // Update monsters and check game over condition
